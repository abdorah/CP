...
public class LegalMove {
   ...
   * @param c
   * @param round
   * @return linkedList for a selected direction in the matrix that start from the point(r,c) till
   *     the end of the matrix following on of the eight directions
   */
   ...
   */
  public static boolean checkMoveOneDirection(
      LinkedList<Character> linkedList, int r, int c, char color) {
  ...
  public static boolean checkMove(char[][] b, int r, int c, char color) {
    ...
    boolean result =
        result0 || result2 || result1 || result3 || result4 || result6 || result5 || result7;
    return result;
  }
}
